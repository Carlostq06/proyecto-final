  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-[#111827] text-white">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className={`fixed z-40 inset-y-0 left-0 w-64 bg-[#1F2937] p-5 border-r border-gray-700 overflow-auto transform transition-transform duration-300 ease-in-out
          ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 md:static md:flex flex-col gap-6`}>
        ...
        <main className="flex-1 flex flex-col overflow-auto relative">
          ...
          <div className="flex justify-between items-center px-6 py-4 border-t border-gray-700 mt-auto">
            <span className="text-gray-400">Total de comercios: {comercios.length}</span>
